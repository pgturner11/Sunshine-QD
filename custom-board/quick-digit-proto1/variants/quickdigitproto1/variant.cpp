...
Pins edited so far: (11/12/21)
Array location    Func.     Sercom
16                tx          5
17                rx          5
31              rs485 tx      4
32              rs485 rx      4

 Changes to be made are highlighted Red on excel sheet
 path: /Users/peytonturner/Desktop/Quickdigit.xlsx

 Header file needs to be updated to reflect changed NINA pins, analog and digit pin numbers, SERCOM and spi pins


 Testing plans: 
  - Logic analyzer for on board communication
      - Spi Instances
          - on board flash, SD Card, nina wifi chip
      - I squared C wire Instances  
          - Atec508A crypto chip
      - RS485
          - tx/rx 
**************************************************/

/*
1) SD card spi needs to have PB10 changed to be a chip select pin to be a digital pin (like PA14)
2) WIFI
      SERCOM 2
        PA12 mosi 
        PA12 miso
        ...
        PA15 sck
        PA27 GPIO 0
        PA05 Reset ( ONLY CHANGE NEEDED ) (done)
 ...
 */
  ...
  { PORTB,  2, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL                            ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },//tx
  { PORTB,  3, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL                            ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, //rx
  { PORTA,  4, PIO_ANALOG,  (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER    ), ADC_Channel4,   PWM0_CH0,   TCC0_CH0,     EXTERNAL_INT_NONE },
  { PORTA,  5, PIO_DIGITAL,  (PIN_ATTR_DIGITAL|PIN_ATTR_ANALOG                ), ADC_Channel5,   PWM0_CH1,   TCC0_CH1,     EXTERNAL_INT_NONE },
